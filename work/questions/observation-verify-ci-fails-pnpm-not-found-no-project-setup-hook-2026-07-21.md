<!-- dorfl-sidecar: item=observation:verify-ci-fails-pnpm-not-found-no-project-setup-hook-2026-07-21 type=observation slug=verify-ci-fails-pnpm-not-found-no-project-setup-hook-2026-07-21 allAnswered=false -->

Item: [`observation:verify-ci-fails-pnpm-not-found-no-project-setup-hook-2026-07-21`](../notes/observations/verify-ci-fails-pnpm-not-found-no-project-setup-hook-2026-07-21.md)

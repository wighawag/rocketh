<!-- dorfl-sidecar: item=task:execute-guard-failure-is-fatal type=task slug=execute-guard-failure-is-fatal allAnswered=false -->

## Q1

**'task:execute-guard-failure-is-fatal' was bounced — how should we proceed?**
...
>
> > rocketh-monorepo@0.5.0 format:check /tmp/dorfl-fresh-gate-k5QoXR/tip
> > prettier --check .
> Checking formatting...
> [warn] work/questions/task-execute-guard-storage-kind.md

<!-- dorfl-sidecar: item=observation:deploy-preguard-never-fired-for-named-safe type=observation slug=deploy-preguard-never-fired-for-named-safe allAnswered=false -->

Item: [`observation:deploy-preguard-never-fired-for-named-safe`](../notes/observations/deploy-preguard-never-fired-for-named-safe.md)

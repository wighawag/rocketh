<!-- dorfl-sidecar: item=observation:numdeployments-is-persisted-only-by-accident type=observation slug=numdeployments-is-persisted-only-by-accident allAnswered=false -->

Item: [`observation:numdeployments-is-persisted-only-by-accident`](../notes/observations/numdeployments-is-persisted-only-by-accident.md)

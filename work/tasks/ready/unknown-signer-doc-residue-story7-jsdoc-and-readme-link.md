...
The parent observation note (`work/notes/observations/review-nits-unknown-signer-integration-scenarios-2026-08-10.md`) is the only durable record of these ratifications and should be left in place; a separate rung will retire it once this task lands.

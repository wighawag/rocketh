...
export async function execute<
	...
	TArgs extends ContractFunctionArgs<TAbi, 'nonpayable' | 'payable', TFunctionName> = ContractFunctionArgs<
		...
		TFunctionName
	>
>(env: Environment, deployment: MinimalDeployment<TAbi>, args: ExecutionArgs<TAbi, TFunctionName, TArgs>) {
...
export async function executeByName<
	...
	TArgs extends ContractFunctionArgs<TAbi, 'nonpayable' | 'payable', TFunctionName> = ContractFunctionArgs<
		...
		TFunctionName
	>
>(env: Environment, name: string, args: ExecutionArgs<TAbi, TFunctionName, TArgs>) {
...
export async function tx(env: Environment, txData: TransactionData): Promise<EIP1193DATA> {
